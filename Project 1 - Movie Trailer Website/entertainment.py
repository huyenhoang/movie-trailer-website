...
# Create new instances of Movie for six movies,
# taking in their Name, Poster Image, and YouTuber Trailer

great_gatsby = media.Movie(
  "The Great Gatsby (1974)",
  "https://upload.wikimedia.org/wikipedia/en/f/fc/Great_gatsby_74.jpg",  # NOQA
  "https://www.youtube.com/watch?v=L-SGqutpxc0"
  )
...
holes = media.Movie(
  "Holes",
  "https://upload.wikimedia.org/wikipedia/en/d/d6/Holesposter03.jpg",  # NOQA
...
# Movies array contains list of movies
# to be displayed by HTML codes within fresh_tomatoes
